...
import { useUncomingMoviesQuery } from "../../../../hooks/useUncomingMovies";
...
import "./UncomingMovieSlide.style.css";
...
const UncomingMovieSlide = () => {
  ...
  const { data, isLoading, isError, error } = useUncomingMoviesQuery();
  ...
  return (
    <div className="movie-slide uncoming">
      <h3>Uncoming Movies</h3>
      <Carousel
